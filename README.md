...
|   技术框架   |      分布式      |                       中间件                        |                      数据库                      | [<font color=green>微服务</font>](微服务.md) | [<font color=green>消息队列</font>](消息队列/消息队列.md) | [<font color=green>DDD</font>](DDD/DDD.md) |  前端   |                  容器编排                  | linux    |
| :----------: | :--------------: | :-------------------------------------------------: | :----------------------------------------------: | :------------------------------------------: | :-------------------------------------------------------: | :----------------------------------------: | :-----: | :----------------------------------------: | -------- |
...
| -------------- | ---- | ------------ | -------- | -------------------------- | ------------------------------------------------ | ------------ | -------------------------------- | ---- | ---- |
|                | 架构 | log4j        | 认证     | [python](python/Python.md) | [<font color=green>java8</font>](java8/Java8.md) |              |                                  |      |      |
|                |      | Resilience4j | 性能优化 |                            |                                                  |              |                                  |      |      |
|                |      |              | 服务网格 |                            |                                                  |              |                                  |      |      |
|                |      |              | 跨域     |                            |                                                  |              |                                  |      |      |
|                |      |              | 幂等方案 |                            |                                                  |              |                                  |      |      |
